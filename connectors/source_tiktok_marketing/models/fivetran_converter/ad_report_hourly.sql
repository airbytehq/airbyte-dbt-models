...
{% elif target.type == "snowflake" %}
    ...
    WITH TMP AS (
        SELECT
            ...
            metrics:"follows"::int AS follows,
            metrics:"impressions"::int AS impressions,
            metrics:"likes"::int AS likes,
            metrics:"profile_visits":: AS profile_visits,
            metrics:"reach"::int AS reach,
            metrics:"shares"::int AS shares,
            metrics:"spend"::int AS spend,
            stat_time_hour,
            metrics:"video_play_actions"::int AS video_play_actions,
            metrics:"video_views_p_25"::int AS video_views_p_25,
            metrics:"video_views_p_50"::int AS video_views_p_50,
            metrics:"video_views_p_75"::int AS video_views_p_75,
            metrics:"video_watched_2_s"::int AS video_watched_2_s,
            metrics:"video_watched_6_s"::int AS video_watched_6_s
        FROM
            {{ source('source_tiktok_marketing', 'ads_reports_hourly') }}
    )
